...
void MainWindow::on_info_about_program_triggered() {
  QMessageBox::information(
      ...
      "Привет, эта программа - 3D Viewer, созданные в целе\n"
...
void MainWindow::on_info_about_developer_triggered() {
  QMessageBox::information(0, "Информация о разработчике",
                           "Разработчиком данной программы, является студент\n"
                           "МГТУ им. Н.Э.Баумана, ИУ7-43Б, Лысцев Никита.");
}
// #########################################################################################################

myerror_t MainWindow::draw() {
...
void MainWindow::on_choose_file_triggered() {
  ...
  myerror_t rc = manager_actions(&request);
